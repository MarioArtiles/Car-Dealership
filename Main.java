...
public class Main {
	...
	//runs code with all other methods and user interface(joptionpane)
	public static void main(String[] args) {
		...
		// decides what action to preform based on option chosen by user
		while (run)
		{
			...
			// shows all cars currently in dealership
			...
			// shows model of all cars currently in dealerships
			...
			// shows all cars in dealership that belong to a specific model
			...
			// removes all cars of a chosen color from the dealership
			...
			// removes all cars of a package from the dealership
			...
			// removes one car from the dealership
			...
			// adds one car to the dealership
